...
import org.apache.hadoop.examples.workload.HDFSWrite;
import org.apache.hadoop.examples.workload.WorkGen;
...
public class ExampleDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("hdfswrite", HDFSWrite.class, "Workload generator");
      pgd.addClass("workgen", WorkGen.class, "Workload generator");
